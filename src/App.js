...
countdown() {
  ...
  start() {
    ...
    this.setState({titleText: "Starting our Quiz!", counter: 0})
    this.timer = setInterval(() => this.countdown(), 1000)
    }
  ...
  return (
    ...
    question={questions[this.state.currentQuestion].question} nextQuestion={(correct) => this.nextQuestion(correct)} 
    ></QuizQuestion>)}
